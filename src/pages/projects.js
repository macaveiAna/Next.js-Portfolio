...
import project3 from "../../public/images/projects/cert-Lspace.png";
    ...
    <main className='w-full mb-16 flex flex-col items-center justify-center dark:text-light'>
        <Layout className='pt-16'>
            ...
            <div className='grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
                ...
                <div className='col-span-6 sm:col-span-12'>
                <Project
                title="L'SPACE Mission Concept Academy"
                img={project3}
                summary="A certificate of completion of L'SPACE Mission Concept Academy, achieved all skill badges from trainings developed by NASA scientists and engineers."
